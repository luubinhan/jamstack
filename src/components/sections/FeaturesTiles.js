...
const FeaturesTiles = ({
  ...
  const sectionHeader = {
    title: 'Sử dụng JAMStack đem lại gì?',
    paragraph: ''
  };
            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  Khả năng đáp ứng Website luôn đạt mức cao nhất
                    </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="200">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                   Do đặc thù kiến trúc JAMStack, khả năng bị tấn công sẽ ít hơn.
                    </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="400">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Chi phí để mở rộng khả năng đáp ứng không quá phức tạp
                    </p>
                </div>
              </div>
            </div>
